...
import brwhmsLogo from "../../../assets/images/brwhms-logo.png";
...
const BRWHMSNode = ({ data }: BRWHMSNodeProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center">
        <img src={brwhmsLogo} alt="BRH" className="w-12 h-12 object-contain" />
      </div>
